      ...
      <View style={styles.container}>
        ...
        >
          <View style={HomeStyles.modalView}>
            ...
            <Text style={HomeStyles.modalText}>
              GoCard Number: {route.params?.goCardNumber}
            </Text>
          </View>
        </Modal>
        ...
        >
          ...
          <View style={FlexDollarsStyles.modal}>
            ...
            <View style={FlexDollarsStyles.dollarsBox}>
              ...
              <Text style={FlexDollarsStyles.dollarsBoxSmallerText}>
                Debit Dollars
              </Text>
            </View>
            <View style={FlexDollarsStyles.dollarsBox}>
                ...
                <TouchableOpacity
                  onPress={() => {
                    ...
                    WebBrowser.openBrowserAsync(
                      "https://eacct-georgetown-sp.transactcampus.com/GOCard/"
                    );
                  }}
                >
                  <Text style={FlexDollarsStyles.buttonText}>
                    Add {"\n"} Money
                  </Text>
                </TouchableOpacity>
              </View>
        ...
        <TouchableOpacity
          activeOpacity={0.8}
          style={HomeStyles.ButtonContainer2}
          onPress={() => {
        ...
        <TouchableOpacity
          activeOpacity={0.8}
          onPress={() => setAccessCardModal(!accessCardModal)}
          style={HomeStyles.ButtonContainer1}
        >
