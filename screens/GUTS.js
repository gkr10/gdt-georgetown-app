...
import GUTSStyles from "../styles/GUTSStyles.js";
          ...
          <View activeOpacity={0.8} style={GUTSStyles.GutsTransportBox}>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <View>
                ...
                <Text style={GUTSStyles.SmallText}>
                  Bus Turnaround {"\n"}6:00AM
                </Text>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <View>
                ...
                <Text style={GUTSStyles.DepatureSmallText}>
          ...
          <View activeOpacity={0.8} style={GUTSStyles.GutsTransportBox}>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <View>
                <Text style={GUTSStyles.DeputureSubheadText}>Departure</Text>
                <Text style={GUTSStyles.DepatureSmallText}>
                  19th Street and North Moore Street {"\n"}5:00AM
                </Text>
              </View>
            </View>
          </View>
